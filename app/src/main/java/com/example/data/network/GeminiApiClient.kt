...
object GeminiApiClient {
    ...
    suspend fun generate(prompt: String, systemPrompt: String? = null): String {
        ...
        if (apiKey.isEmpty() || apiKey == "MY_GEMINI_API_KEY") {
            return "Please set your GEMINI_API_KEY in the Secrets panel in AI Studio to use real-time AI story and translation services."
        }
        ...
        return try {
            ...
            "Error: ${e.localizedMessage ?: "Could not connect to AI services."}"
        }
    }
}
